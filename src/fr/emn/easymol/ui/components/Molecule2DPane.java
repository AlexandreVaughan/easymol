...
public class Molecule2DPane extends JPanel implements IMoleculePane,
    ...
    public void insertCompound(AbstractChemicalCompound acc, double x, double y) {
        ...
        try {
            ...
            // e.printStackTrace(); ==> better to do nothing, avoids pollutiong output
            // TODO: maybe send an informative message to the user on why the auto link failed
            //try and continue
        }
    }
    ...
    private void createMoleculeGraph() {
        ...
        for (Enumeration e = molecule.getBonds(); e.hasMoreElements();) {
            ...
            if (acb instanceof ValencyBond)
                GraphConstants.setLineWidth(edgeAttrib, ((ValencyBond) acb)
                        .getBondType());
