...
// TODO : test and re-document this class
/**
 ...
 * @see VSEPRMolecule
 */
public class Molecule3DPane extends JPanel implements IMoleculePane {
    ...
    private VSEPRAlgorithm vsepr = null;
     ...
     */
    public Molecule3DPane(Molecule m) {
        // Window creation
        //GraphicsConfiguration def =
        // (GraphicsEnvironment.getLocalGraphicsEnvironment()).getDefaultScreenDevice().getDefaultConfiguration();
        vsepr = new VSEPRAlgorithm();
        m.addObserver(this);
        this.setMolecule(m);
    ...
    private BranchGroup createSceneGraph(SimpleUniverse su, Molecule m,
        ...
        vsepr.setData(m);
        t3n.add("North", new JLabel("Name : " + m.getName() + ", Symbol : "
                + m.getSymbol()));
