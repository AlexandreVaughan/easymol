 ...
 * These exceptions are defined by an error code number, the name (string) of the
 * module/class that issued the exception, and the exception message.
 * </p>
 * 
...
public class EasyMolException extends Exception {
    ...
    /**
     * Gets the fully filled (with all attributes) message of this easymol exception.
     */
