...
public class VSEPRMolecule3D {
    ...
    public static Appearance getAtomAppearance(int atomType) {
        ...
        case VSEPRAtom.S:
            ...
            m.setAmbientColor(new Color3f(0.0f, 1.0f, 0.0f));
            m.setDiffuseColor(new Color3f(0.3f, 0.3f, 0.3f));
            m.setSpecularColor(new Color3f(0.125f, 0.125f, 0.125f));
            break;
        case VSEPRAtom.P:
            ca.setColor(new Color3f(1.0f, 1.0f, 0.0f));
            m.setAmbientColor(new Color3f(1.0f, 1.0f, 0.0f));
            m.setDiffuseColor(new Color3f(0.3f, 0.3f, 0.3f));
            m.setSpecularColor(new Color3f(0.125f, 0.125f, 0.125f));
            break;
        default:
    ...
    private BranchGroup moleculeView(VSEPRMoleculeNode current,
        ...
        rotateZ.rotZ(theta.getAngleZ() + Math.PI); 
        // The PI here is to make the atom repulse from his parent (thank you Pi)
        rotateY.mul(rotateZ);
        rotateX.mul(rotateY);
        ...
        atom.setAppearance(getAtomAppearance(current.getType()));
