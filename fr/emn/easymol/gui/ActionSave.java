 ...
 * 06/27/2002
 *
 * ActionSave.java - The "Save" action
...
/** The class to register the action "Save".<br>
...
**/
   ...
   **/
      public ActionSave(ToolBarWindow toolB, String name, String toolTip, KeyStroke accelerator, Icon icon){
         super(name,icon);
