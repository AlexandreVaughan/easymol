 ...
 * 06/27/2002
 *
 * ActionSaveAll.java - The "Save All" action
...
/** The class to register the action "Save All".<br>
...
**/
   ...
   **/
      public ActionSaveAll(ToolBarWindow toolB, String name, String toolTip, KeyStroke accelerator, Icon icon){
         super(name,icon);
