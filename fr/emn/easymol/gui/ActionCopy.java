 ...
 * 06/27/2002
 *
 * ActionCopy.java - The "Copy" action
...
/** The class to register the action "Copy".<br>
...
**/
   ...
   **/
      public ActionCopy(ToolBarWindow toolB, String name, String toolTip, KeyStroke accelerator, Icon icon){
         super(name,icon);
   ...
   /** The action connected to item "Copy" in menus or toolbars.
