...
/** The class to register the action "Cut".<br>
...
**/
   ...
   **/
      public ActionCut(ToolBarWindow toolB, String name, String toolTip, KeyStroke accelerator, Icon icon){
         super(name,icon);
   ...
   /** The action connected to item "Cut" in menus or toolbars.
