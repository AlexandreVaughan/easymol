...
/** The class to register the action "New".<br>
...
**/
   ...
   **/
      public ActionNew(ToolBarWindow toolB, String name, String toolTip, KeyStroke accelerator, Icon icon){
         super(name,icon);
