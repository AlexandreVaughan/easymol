 ...
 * 06/27/2002
 *
 * ActionCloseAll.java - The "Close All" action
...
/** The class to register the action "Close All".<br>
...
**/
   ...
   **/
      public ActionCloseAll(ToolBarWindow toolB, String name, String toolTip, KeyStroke accelerator, Icon icon){
         super(name,icon);
