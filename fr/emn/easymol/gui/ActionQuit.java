 ...
 * 06/27/2002
 *
 * ActionQuit.java - The "Quit" action
...
/** The class to register the action "Quit".<br>
...
**/
   ...
   **/
      ...
      public ActionQuit(ToolBarWindow toolB, String name, String toolTip, KeyStroke accelerator, Icon icon){
         super(name,icon);
