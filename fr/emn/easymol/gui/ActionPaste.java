 ...
 * 06/27/2002
 *
 * ActionPaste.java - The "Paste" action
...
/** The class to register the action "Paste".<br>
...
**/
   ...
   **/
      public ActionPaste(ToolBarWindow toolB, String name, String toolTip, KeyStroke accelerator, Icon icon){
         super(name,icon);
